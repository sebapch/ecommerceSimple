...
function ProductList() {
  ...
  return (
    <div className=" p-4 mt-4 max-w-md mx-auto overflow-hidden min-h-screen flex flex-col">
      ...
      <div className="px-4 mt-4">
        ...
        <h1 className="text-2xl font-bold mb-4 text-left text-darkGray">
          Welcome Back!
        </h1>

        <h3 className="text-xl font-semibold mb-4 text-left text-darkGray">
          Our Products
        </h3>
      </div>
      ...
      <div className="grid grid-cols-2 gap-5 p-4">
        {products.map((product) => (
          ...
          >
            <div className="">
              <h2 className="text-lg text-darkGray font-medium mb-2">
                {product.brand}
              </h2>
              <img
                src={product.image}
              ...
              <div className="flex justify-between items-center">
                <span className="text-xl font-semibold px-4 text-darkGray">
                  {" "}
                  {prices[product.id]
                ...
                <Link
                  ...
                  className="w-12 h-12"
                >
                  <img src="/icons/add.png" className="w-12 h-12" />
                </Link>
              </div>
            </div>
          </div>
